...
public class BaseUrl {
    ...
    public static final String GET_PAYMENTS_URL="PaymentModeManagementService/paymentmodes/";
    public static final String MAKE_SALES="AndroidWebService/pos/sale";//    AndroidWebService/pos/sale
}
